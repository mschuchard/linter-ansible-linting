    ...
    return {
      ...
      lint: (activeEditor) => {
        ...
        .catch(error => {
          ...
          const matches_three = /(?:raise Ansible(Parser)?Error|Syntax Error while loading YAML|Couldn't parse task at)/.exec(error.message);
          ...
          if (matches != null) {
            ...
            toReturn.push({
              type: 'Error',
              range: 1,
              text: 'An unexpected error with ansible, ansible-lint, linter-ansible-linting, atom, atom-linter, or your playbook, has occurred.',
              filePath: file
            });
          }
          return toReturn;
