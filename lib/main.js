  ...
  provideLinter: () => {
    return {
      ...
      lint: (activeEditor) => {
        ...
        // skip certain checks
        var skips = ['ANSIBLE0002', 'ANSIBLE0004', 'ANSIBLE0005', 'ANSIBLE0006', 'ANSIBLE0007', 'ANSIBLE0008', 'ANSIBLE0009', 'ANSIBLE0010', 'ANSIBLE0011', 'ANSIBLE0012', 'ANSIBLE0013', 'ANSIBLE0014', 'ANSIBLE0015', 'ANSIBLE0016', 'ANSIBLE0017']
        var skipList = ''
