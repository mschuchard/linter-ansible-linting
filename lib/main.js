  ...
  provideLinter() {
    return {
      ...
      lint: (activeEditor) => {
        ...
        if ((atom.config.get('linter-ansible-linting.lintProject')) && (!(/hosts:/.exec(activeEditor.getText()))) && (!(projectPath == null)))
            ...
            // check for linting issues in other files
              ...
              toReturn.push({
                ...
                location: {
                  ...
                  // prepend dir to file
                  file: projectPath + lint_matches[1],
                  position: [[Number.parseInt(lint_matches[2]) - 1, 0], [Number.parseInt(lint_matches[2]) - 1, 1]],
                },
              });
            }
            // check for ansible-lint 5 output linting issues
              ...
              toReturn.push({
                ...
                location: {
                  // ansible-lint plus atom-linter combined now lose pathing info for this kind of parsing
                  // prepend dir to file
                  file: projectPath + lint_matches_new[1],
            ...
            // check for ansible-lint 5 syntax issues
              ...
              toReturn.push({
                ...
                location: {
                  // ansible-lint plus atom-linter combined now lose pathing info for this kind of parsing
                  // prepend dir to file
                  file: projectPath + lint_matches_syntax[1],
